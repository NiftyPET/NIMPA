...
__all__ = [
    ...
    'affine_niftyreg', 'array2nii', 'bias_field_correction', 'centre_mass_img',
    'coreg_spm', 'coreg_vinci', 'create_dir', 'create_mask', 'ct2mu', 'dcm2im',
    'dcm2nii', 'dcmanonym', 'dcminfo', 'dcmsort', 'dice_coeff',
    'dice_coeff_multiclass', 'fwhm2sig', 'getnii', 'getnii_descr', 'im_cut',
    'imfill', 'imsmooth', 'iyang', 'motion_reg', 'nii_gzip', 'nii_modify',
    'nii_ugzip', 'niisort', 'orientnii', 'pet2pet_rigid', 'pick_t1w', 'psf_general',
    'psf_measured', 'pvc_iyang', 'realign_mltp_spm', 'resample_fsl',
